...
import {
  ...
  Settings,
  User,
  ChartNoAxesGantt as Chart,
  Activity as Interview,
  FileUser as Resume,
  LetterText as CoverLetter,
} from "lucide-react";
...
const AppSidebar = () => {
  ...
  const navLinks = {
    student: [
      { icon: Chart, label: "Overview", href: "/user/overview" },
      { icon: Interview, label: "Interview", href: "/user/interview" },
      { icon: BookOpen, label: "Courses", href: "/user/courses" },
      { icon: Resume, label: "Resume", href: "/user/resume" },
      { icon: CoverLetter, label: "Cover Letter", href: "/user/cover-letter" },
      { icon: Briefcase, label: "Billing", href: "/user/billing" },
      { icon: User, label: "Profile", href: "/user/profile" },
      { icon: Settings, label: "Settings", href: "/user/settings" },
    ],
    teacher: [
      { icon: Chart, label: "Overview", href: "/teacher/overview" },
      { icon: BookOpen, label: "Courses", href: "/teacher/courses" },
      { icon: Resume, label: "Resume", href: "/teacher/resume" },
      {
        icon: CoverLetter,
        label: "Cover Letter",
        href: "/teacher/cover-letter",
      },
            ...
            >
              <div className="app-sidebar__logo-container group">
                <div className="app-sidebar__logo-wrapper">
                  ...
                  />
                  <p className="app-sidebar__title">JobMatch</p>
                </div>
